...
- Ambos os botões alteram se alternam o status. Caso nenhum dos dados seja nulo, e o limite inferior for menor do que o limite superior, o sorteio irá acontecer e o estado do botão mudará.
